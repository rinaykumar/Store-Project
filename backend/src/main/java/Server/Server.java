...
public class Server {
    ...
    public static void main(String[] args){
        ...
        post("/api/createTrans", (req,res) -> {
            ...
            TransDAO.createTransaction(transactionDTO.item,transactionDTO.price,transactionDTO.quantity);
            System.out.println(bodyString);
            System.out.println(items.size());
        ...
        post("/api/getTrans", (req,res) -> {
            ...
            TransListDTO Tranlist = transactionDAO.listTransaction();
            return gson.toJson(Tranlist);
        });
    }
}
